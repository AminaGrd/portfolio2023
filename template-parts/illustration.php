                    ...
                    ?><div class="swiper-slide">
                        <div class="cs-post-item">
                            ...
                            <div class="cs-post-thumb">
                                <div class="prev-slide" onclick="plusSlides(-1)"><img src="<?php bloginfo('stylesheet_directory'); ?>/assets/img/illustration/illustration.svg" alt="illustration"></div>
                                <a href="<?php the_permalink();?>"><img src="<?php the_post_thumbnail_url();?>" alt="<?php the_title();?>"></a>
                                <div class="next-slide" onclick="plusSlides(1)"><img src="<?php bloginfo('stylesheet_directory'); ?>/assets/img/illustration/illustration.svg" alt="illustration"></div>
                            </div>
